<footer class="footer-area section_gap">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-footer-widget">
                    <h6 class="footer_title"><fmt:message key="navi"/></h6>
                    <div class="row">
                        <div class="col-4">
                            <ul class="list_style">
                        ...
                        <div class="col-4">
                            <ul class="list_style">
                                <li><a href="/api?command=aboutUs"><fmt:message key="about_us"/></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            ...
            <h5><fmt:message key="this_web_site"/> <i class="fa fa-heart-o" aria-hidden="true"></i>
            <fmt:message key="by"/></h5>
